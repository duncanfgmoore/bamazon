  ...
  connection.query("SELECT * FROM products", function(err, res) {
    ...
    inquirer
      ...
      .then(function(response) {
        ...
        console.log(
          "\nID: " +
            res[chosenItem].item_id +
            "\nProduct: " +
            res[chosenItem].product_name +
            "\nPrice: " +
            res[chosenItem].price +
            "\nQuantity: " +
            ...
            if (purchase.checkout <= res[chosenItem].stock_quantity) {
              ...
              var query = connection.query(
                ...
                [
                  {
                    stock_quantity:
                      res[chosenItem].stock_quantity - purchase.checkout,
                    product_sales:
                      parseInt(res[chosenItem].product_sales) +
                      parseInt(purchase.checkout * res[chosenItem].price)
                  },
                  {
